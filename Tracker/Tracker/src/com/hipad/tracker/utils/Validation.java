...
public class Validation {  
    ...
    /**
     * 匹配由数字、26个英文字母或者下划线组成的6~20的字符串^\\w{6,20}$
     */
    public static final String STR_ENG_NUM_LTD="^\\w{6,20}$";
    /** 
...
////------------------验证方法       
    ...
    public static boolean isENG_NUM_LTD(String str){
    	return Regular(str, STR_ENG_NUM_LTD);
    }
    /** 
     * 过滤特殊字符串 返回过滤后的字符串 
     * @param str 

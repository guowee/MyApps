...
public abstract class Chart {
	public String[] xDataTitles;
	public double[] yDataValues;
	public double maxYValue, minYValue;
	public String maxXTitle, minXTitle;

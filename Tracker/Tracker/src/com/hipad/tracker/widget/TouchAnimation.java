...
public class TouchAnimation extends FrameLayout {
    ...
    public TouchAnimation(Context context, AttributeSet attrs) {
        super( context, attrs);
        this.drawable=(AnimationDrawable)getResources().getDrawable( R.drawable.touch_animation);
        init();
    }
    ...
    public void updateLoading(boolean success, String tips) {
        if(success) {
            ...
            mPromptImage.setBackgroundResource( R.drawable.loading_000);
        }
    }

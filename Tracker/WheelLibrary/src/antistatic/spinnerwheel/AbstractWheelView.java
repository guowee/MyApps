...
public abstract class AbstractWheelView extends AbstractWheel {
    ...
    protected static final int DEF_ITEMS_DIMMED_ALPHA = 70; // 60 in ICS
    ...
    protected static final int DEF_SELECTION_DIVIDER_SIZE = 1;
    ...
    protected void onScrollTouchedUp() {
        ...
        fadeSelectorWheel(1000);
        lightSeparators(2000);
    }

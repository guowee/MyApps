...
import com.haomee.chat.Utils.video.ImageCache;
import com.haomee.chat.Utils.video.ImageResizer;
import com.haomee.chat.Utils.video.Utils;
import com.haomee.chat.domain.VideoEntity;
import com.haomee.chat.widget.RecyclingImageView;
import com.haomee.liulian.BuildConfig;
...
public class ImageGridFragment extends Fragment implements OnItemClickListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		final View v = inflater.inflate(R.layout.chat_image_grid_fragment, container, false);
	...
	private class ImageAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup container) {
			...
			if (convertView == null) {
				...
				convertView = LayoutInflater.from(mContext).inflate(R.layout.chat_choose_griditem, container, false);
			...
			if (position == 0) {
				...
				holder.imageView.setImageResource(R.drawable.item_icon);
			} else {

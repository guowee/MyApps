...
public class MoreEmotionsActivity extends BaseActivity {
	...
	private ImageView iv_emotions_background;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		this.imageLoader = ImageLoaderCharles.getInstance(MoreEmotionsActivity.this);
		initView();
	}
	...
	private void initView() {
		...
		iv_emotions_background=(ImageView) findViewById(R.id.iv_emotions_background);
		get_emotions_list();
	}
		...
		asyncHttp.get(url, new AsyncHttpResponseHandler() {
			...
			public void onSuccess(String arg0) {
				...
				try {
					...
					imageLoader.addTask(obj.optString("pic"), iv_emotions_background);
					...
					for (int index = 0; index < array.length(); index++) {
						...
						emotion_item.setIs_new(json_obj.optBoolean("new"));
						emotion_item.setDesc(json_obj.optString("desc"));

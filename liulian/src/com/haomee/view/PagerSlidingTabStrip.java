...
//	private int selectedPosition = 0;
	...
	private int[] selected_images = { R.drawable.tabbar_button_1_pressed, R.drawable.tabbar_button_2_pressed, R.drawable.tabbar_button_3_pressed, R.drawable.tabbar_button_5_pressed };

	private int[] default_images = { R.drawable.radar_default, R.drawable.test_default, R.drawable.discover_default, R.drawable.personal_default };
		...
		for (int i = 0; i < tabCount; i++) {
			...
			if (v instanceof ImageButton) {
				...
				if (i == currentPosition) {
					tab.setImageResource(selected_images[i]);
				}else{
					tab.setImageResource(default_images[i]);
				}
			}

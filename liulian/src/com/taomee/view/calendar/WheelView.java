...
package com.taomee.view.calendar;
...
public class WheelView extends View {
	...
	private static final int VALUE_TEXT_COLOR = 0xFfffa451;

	/** Items text color */
	private static final int ITEMS_TEXT_COLOR = 0xFF4f4f4f;
	...
	private void initResourcesIfNecessary() {
		if (itemsPaint == null) {
			...
			itemsPaint.setTextSize(getResources().getDimension(R.dimen.paint_size));
		}
		...
		if (valuePaint == null) {
			...
			valuePaint.setTextSize(getResources().getDimension(R.dimen.paint_size));

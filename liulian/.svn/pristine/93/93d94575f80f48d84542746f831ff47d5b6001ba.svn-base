...
public class PreferenceUtils {
	...
	private String SHARED_KEY_SETTING_SOUND_OP = "shared_key_sound_operation";
	...
	public void setSettingSound_operation(boolean paramBoolean) {
		editor.putBoolean(SHARED_KEY_SETTING_SOUND_OP, paramBoolean);
		editor.commit();
	}

	public boolean getSettingSound_operation() {
		return mSharedPreferences.getBoolean(SHARED_KEY_SETTING_SOUND_OP, true);
	}

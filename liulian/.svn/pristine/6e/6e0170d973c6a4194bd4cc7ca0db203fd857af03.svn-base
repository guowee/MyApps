...
import com.haomee.liulian.ContentList;
import com.haomee.liulian.StartActivity;
...
public class MyPushMessageReceiver extends FrontiaPushMessageReceiver {
		...
		if (!TextUtils.isEmpty(customContentString)) {
			...
			try {
				...
				if (type.equals("1")) {
					...
					intent.putExtra("topic_id", myvalue);
					intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
					context.getApplicationContext().startActivity(intent);
	...
	/*
	 * private void updateContent(Context context, String content) { Log.d(TAG,
	 * "updateContent"); String logText = "" + Utils.logStringCache;
	 * 
	 * if (!logText.equals("")) { logText += "\n"; }
	 * 
	 * SimpleDateFormat sDateFormat = new SimpleDateFormat("HH-mm-ss"); logText
	 * += sDateFormat.format(new Date()) + ": "; logText += content;
	 * 

...
public class UserDao {
	public static final String CHAT_USER_HISTORY = "user_history";
	
	public static final String COLUMN_HISTORY_NAME_ID = "username";
	public static final String COLUMN_HISTORY_NAME_NICK = "nick";
	public static final String COLUMN_HISTORY_NAME_ICON = "icon";
	...
	public void saveChatHistoryUserList(List<User> contactList) {
		SQLiteDatabase db = dbHelper.getWritableDatabase();
		if (db.isOpen()) {
			db.delete(CHAT_USER_HISTORY, null, null);

...
public class PhotoFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mGrid = (GridView) rootView.findViewById(R.id.photo_grid);
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		if (getActivity() != null) {
			new ListPhotoFilesTask(this, mPath).start();
			getActivity().findViewById(R.id.photo_progress_large).setVisibility(View.VISIBLE);
		}
	}	
	...
	public class GridMultiChoiceModeListener implements GridView.MultiChoiceModeListener {
        ...
        public boolean onActionItemClicked(ActionMode mode, MenuItem item) {
        	...
        	case R.id.lock:
        	{
        		...
        		if (paths.size() > 0)
        			new MovePhotoFilesTask(PhotoFragment.this, MovePhotoFilesTask.OP_LOCK, paths).start();
        	...
        	case R.id.unlock:
        	{
        		...
        		if (paths.size() > 0)
        			new MovePhotoFilesTask(PhotoFragment.this, MovePhotoFilesTask.OP_UNLOCK, paths).start();

...
public class HttpPostWraper extends HttpPost {
	...
	/**
	 * add the name-value pair to the http post. after all the name-value pairs is added, the {@link HttpPostWraper#commitParams()} should be called.
	 * @param name
	 * 		the name
	 * @param value
	 * 		the value

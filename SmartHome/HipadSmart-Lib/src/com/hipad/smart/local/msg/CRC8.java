...
public class CRC8 {
	private final static byte[] CRC8_TAB = { (byte) 0, (byte) 94, (byte) 188, (byte) 226,
			...
			(byte) 84, (byte) 215, (byte) 137, (byte) 107, (byte) 53 };
	...
	public static void test(String[] args) {
		...
		System.out.println("crc: " + Integer.toHexString(0x00ff & crc));
	}
}
